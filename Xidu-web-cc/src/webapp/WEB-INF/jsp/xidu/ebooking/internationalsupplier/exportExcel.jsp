...
<%
   response.setHeader("Content-disposition","inline; filename=internationSupplier.xls");
										...
										<tbody>
											<tr height="78"
												...
												<td width="901" valign="top" height="78" align="left"
													style="height: 58.5pt; width: 360pt" colspan="5"></td>
											</tr>
											<tr height="28"
											...
											<tr height="29"
												...
												<td height="29" style="height: 21.75pt" class="xl169"
													...
													style="font-weight: bold; color: #F00;">*</span></td>
												<td style="border-top: none; border-left: none" class="xl77">${intersupplier.totalPallets}</td>
												...
												<td width="901" valign="top" height="29" align="left"
													...
													style="mso-ignore: vglayout2">
														<table cellspacing="0" cellpadding="0">
															<tbody>
																<tr>
																	<td width="900" height="29" colspan="4" class="xl139"
																		style="height: 21.75pt; width: 647pt">Please
																		circle the level of stackability of your Pallets?<span
																		style="mso-spacerun: yes"> </span>
																	</td>
																	<td colspan="2">
																	 <input type="radio" disabled="disabled"  name="palletsLevel" value="1" style="vertical-align: middle"/>	
																		<span style="mso-spacerun: yes">
																	</span>1
																		</td><td>
																	
																	<input type="radio" disabled="disabled"  name="palletsLevel" value="2" style="vertical-align: middle"/>	
																	<span style="mso-spacerun: yes"></span> 
																		2
																		</td><td>
																	 <input type="radio" disabled="disabled"  name="palletsLevel" value="3" style="vertical-align: middle"/>	
																		<span style="mso-spacerun: yes">
																	</span>3
																		</td><td>
																		
																	
																	 <input type="radio" disabled="disabled" name="palletsLevel" value="4" style="vertical-align: middle"/>	
																		<span style="mso-spacerun: yes">
																	</span>4
																		</td><td colspan="2">
																		
																	
																	 <input type="radio" disabled="disabled"  name="palletsLevel" value="5" style="vertical-align: middle"/>	
																		<span style="mso-spacerun: yes">
																	</span> 5<form:hidden path="palletsLevel" />
																	</td>
																</tr>
															</tbody>
														</table>
