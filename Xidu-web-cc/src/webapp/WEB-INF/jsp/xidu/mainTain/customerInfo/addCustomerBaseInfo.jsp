...
<%@page import="com.zhibo.mainTain.util.PropertiesConfig"%>
...
<%
	String loginId=((SessionUserDto)request.getSession().getAttribute("currentUser")).getUserId()+"";
	String changeVIP=PropertiesConfig.readData("", "xidu.defaut.changeVIP");
%>
	                    ...
	                    <fieldset><legend name="Legend1" class="legend" id="Legend1">详情</legend>
							        <table cellspacing="1" cellpadding="1" width="100%" >
								        ...
								        <tr>
									        ...
									        <td nowrap="">
									            <form:input path="videoTime" cssStyle="width:190px;" cssClass="userInput " maxlength="100"/>分钟（0为无限时间）
									          </td>
                                        ...
                                        <tr>
									        ...
									        <td nowrap="">
									        	 <form:select path="type_id" cssClass="userInput " >
									        	 	<form:option value="0" >试用会员</form:option>
									        		<form:option value="1">普通会员</form:option>
									        		<%if(changeVIP.indexOf(loginId)!=-1){%>
								        ...
								        <%if("61".equals(dto.getParentId())||dto.getRole().getId()==1){%>
								        <tr>
									        <td align="right" nowrap=""><span class="LabelBold" id="lblStackQty">房间号:</span></td>
									        <td nowrap="">
									        	 <form:select path="roomNo" cssClass="userInput ">
									        		<form:option value="1">普通</form:option>
									        		<form:option value="12">VIP</form:option>
									        	</form:select>
									        </td>
								        </tr>
								        <%} %>
