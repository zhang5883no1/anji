...
<%@include file="../../include/baseJsAndCss.jsp"%>
  ...
  <title>
	...
	var id="";
		function search(){
			submitFormForAnji("tradingTips_form","${webcontext}/mainTain/tradingTips/queryTradingTips",0);
		}
		//add 
		function addCustomer(){
			$("#id").val("");
			$("#tradingTips_form").attr("action","addOrEditTradingTips");
			submitFormForAnji("tradingTips_form","${webcontext}/mainTain/tradingTips/addOrEditTradingTips",0);
//			$("#tradingTips_form").submit();
		}
		//edit
...
//			$("#tradingTips_form").submit();
        ...
        function deleteCustomer(){
        	...
        	if(confirm('Do you confirm to delete this record?')){
	        	$("#id").val(selCustomer.val());
	        	$("#tradingTips_form").attr("action","deleteTradingTips");
				submitFormForAnji("tradingTips_form","${webcontext}/mainTain/tradingTips/deleteTradingTips",0);
//		 		$("#tradingTips_form").submit();
		    }
        }
    </script>   
...
<body style="cursor: default;" leftmargin="0" topmargin="0">
  ...
  <table border="0" cellspacing="2" width="100%">
    <tbody>
      <tr>
        <td><span id="lblHeader" class="PageTitle">操作建议</span></td>
      </tr>
    </tbody>
  </table>
  <form:form id="tradingTips_form" name ="tradingTips_form" action="queryTradingTips" method="post" modelAttribute="queryTradingTipsDto">
        ...
        <td><table border="0" cellpadding="1" cellspacing="1" width="100%">
            <tbody>
              <tr>
                <td colspan="2"><div id="resizableDiv" class="DivResultsGrid" style="OVERFLOW: auto;border-top:solid 1px silver">
                      <ec:table styleClass="DataGrid"  style="height:25px;width:100%;" border="1"  cellpadding="0" cellspacing="0" tableId="tableResults" form="tradingTips_form"
					   items="queryTradingTipsDto.resultList"
					   action="${webcontext}/mainTain/tradingTips/queryTradingTips"
          ...
          <table style="width:100%">
            <tr>
              ...
              <input style="width:90px; text-align:center;" class="Button" type="button"  id="btnReset" onClick="editCustomer();" value="Edit" name="btnEdit">
             <input style="width:90px; text-align:center;" class="Button" type="button"  id="btnReset" onclick="deleteCustomer();" value="Delete" name="btnDelete">
             </td>
            </tr>
          </table>
          </td>
