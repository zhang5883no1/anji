	                    ...
	                    <fieldset><legend name="Legend1" class="legend" id="Legend1">详细</legend>
							        <table cellspacing="1" cellpadding="1" width="100%">
								        <tbody><tr width="100%">
									        ...
									        <td nowrap="">
									        	<form:input path="openTime" cssStyle="width:190px;" cssClass="userInput Wdate" maxlength="40" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss' })"/>
									        </td>
                                        ...
                                        <tr>
								         ...
								         <tr>
                                           <td align="right" nowrap=""><span style="display:inline-block;" class="LabelBold" id="lblLength">止盈价:</span></td>
									        ...
									        <td nowrap="">
									        	<form:input path="closingTime" cssStyle="width:190px;" cssClass="userInput Wdate" maxlength="40" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss' })"/>
									        </td>
								        </tr>
								         <tr>
