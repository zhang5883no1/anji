  ...
  <title>
	...
	<script LANGUAGE="JavaScript">		
		function saveCUstomer(){
			submitFormForAnji("addAdmin_form","${webcontext}/mainTain/adminInfo/saveAdmin",0);
		}
	                    ...
	                    <fieldset><legend name="Legend1" class="legend" id="Legend1">详细</legend>
							        <table cellspacing="1" cellpadding="1" width="100%">
								        ...
								        <tr>
									        ...
									        <td nowrap="">
									        	<form:input path="mobile" cssStyle="width:190px;" cssClass="RequiredField userInput " maxlength="100"/>
									        </td>
								        </tr>
								          <tr>
								        ...
								        <tr>
									        ...
									        <td nowrap="">
									            <form:input path="videoTime" cssStyle="width:190px;" cssClass="userInput " maxlength="100"/>
									          </td>
								        ...
								        <tr>
									        ...
									        <td nowrap="">
									        	 <form:input path="userId" cssStyle="width:190px;" cssClass="userInput" maxlength="100"/>
									        </td>
