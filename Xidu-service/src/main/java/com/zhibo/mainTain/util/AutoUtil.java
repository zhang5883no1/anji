...
public class AutoUtil {
	...
	public List<CustomerBasicInfoDto> autoCreateCustomer(int size,long userId){
		List<CustomerBasicInfoDto> list=new ArrayList<CustomerBasicInfoDto>();
		for(int i=0;i<size;i++){
			CustomerBasicInfoDto info=new CustomerBasicInfoDto();
			int rdnum=rd.nextInt(facelength)+1;
			list.add(info);
		}
		return list;
